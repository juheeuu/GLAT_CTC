...
@register_task("translation_lev_ctc", dataclass=TranslationLevenshteinConfig)
class TranslationLevenshteinCTCTask(TranslationTask):
    """
    ...
    def _inference_with_bleu(self, generator, sample, model):
        ...
        for i in range(len(gen_out)):
            ...
            gen_tokens_collapsed = token_collapse(gen_out[i][0]["tokens"])
            gen_tokens_collapsed = gen_tokens_collapsed[gen_tokens_collapsed!=0]
            
            hyps.append(decode(gen_tokens_collapsed))
            refs.append(
                decode(
